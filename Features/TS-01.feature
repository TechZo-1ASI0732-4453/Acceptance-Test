Feature: TS01 - API User
  ...
  Scenario: Diseño de la API User
    Given  el usuario developer configura la plataforma
    When diseña la API para gestionar usuarios en nuestra aplicación movil
  ...
  Scenario: Selección de la tecnología para la API
    Given  el usuario developer está diseñando la API para gestionar usuarios en nuestra aplicación movil
